...
const Header = () => {
  ...
  const menuOpen = () =>{
    ...
    <div className="header">
      <div className="container is-max-desktop is-flex is-align-items-center is-justify-content-space-between">
      ...
      <div className={`mobile-munu is-overlay navbar-menu is-hidden-desktop is-hidden-tablet is-relative mx-5 py-0 ${isOpenMenu ? "is-active" : ""} `}>
