...
export const PotDeleteModal = ({ openModal, closeModal, modalType, idx }: any) => {
	...
	return (
		<div className="fixed inset-0 z-50 flex justify-center items-center bg-opacity-100">
						...
						<div className="bg-white p-6 rounded-xl shadow-xl max-w-sm w-full relative">
							...
							<button type="button" className="text-xs w-full py-3 px-4 bg-red-600 text-white font-normal rounded-md focus:outline-none">Yes, Confirm Deletion</button>
							<button 
								type="button" 
								onClick={(e:any)=> handleBackdropClick(e)} 
